...
namespace Infrastructure.Web.Engine
{
    ...
    {
        private static readonly Lazy<Action<WebViewPage, string>> OverriddenLayoutSetter = 
            new Lazy<Action<WebViewPage, string>>(CreateOverriddenLayoutSetterDelegate);
        private readonly Type _type;
        private readonly string _virtualPath;
        private readonly string _masterPath;
        private readonly IViewPageActivator _viewPageActivator = DefaultViewPageActivator.Current;

        public PrecompiledView(string virtualPath, Type type, bool runViewStartPages, IEnumerable<string> fileExtension)
        ...
        public void Render(ViewContext viewContext, TextWriter writer)
        {
            ...
            {
                OverriddenLayoutSetter.Value(webViewPage, _masterPath);
            }
